 ...
 * 沙贼
 */
public class SandPoacher extends Spider implements GeoEntity {
    ...
    public SandPoacher(EntityType<? extends Spider> type, Level level) {
        super(type, level);
    ...
    protected SoundEvent getAmbientSound() {
        return TESounds.ANTLION_FREE.get();
    }
    @Override
