...
public class DestroyerRenderer extends GeoNormalRenderer<Destroyer> {
    ...
    @Override
    public void preRender(PoseStack poseStack, Destroyer animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        // 获取并应用 Roll
